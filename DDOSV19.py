...
def usage():
    ...
    print "#-----------------------------------------------------------#"
    print "# \033[1;91mMenjalankan: ""python2 V19DDOS.py " "<ip> <port> <packet> \033[1;32m#"
    print "# \033[1;91mMenjalankan: ""CONTOH:python2 V19DDOS.py" "51.333.342 80 100 \033[1;32m#" 
